...
<div class="row">
	<div class="col-md-12 panel-info">
		<div class="content-box-header panel-heading">
			<div class="panel-title ">Sửa bất động sản</div>
		</div>
		<div class="content-box-large box-with-header">
			<div>
				<div class="row mb-10"></div>
				<form action="${pageContext.request.contextPath }/admin/land/edit/${itemLand.lid}" method="post" enctype="multipart/form-data" >
					<div class="row">
						<div class="col-sm-6">
								...
								<c:choose>
									...
									<select class="form-control" name="cid" >
										<c:forEach items="${listCat }" var="itemCat">
											...
											value="${itemCat.cid }" >${itemCat.cname }</option>
										</c:forEach>
									</select>
									</c:when>
								</c:choose>		
							...
							<div class="form-group">
								...
								<input type="number" name="area" value="${itemLand.area }" value="0" step="5" class="form-control" placeholder="Nhập diện tích bằng số m2">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label>Mô tả</label><form:errors cssStyle="color:red; font-style:italic;" path="landErr.description"></form:errors>
								<textarea name="description" class="form-control" rows="3">${itemLand.description }</textarea>
							</div>
							<div class="form-group">
