...
<%@taglib uri="http://www.springframework.org/tags/form" prefix="form" %>
	<div class="clearfix content">
		<div class="contact_us">
			...
			<form action="${pageContext.request.contextPath }/edit-${SlugUtil.makeSlug(itemLand.lname)}/${itemLand.lid}" method="post" enctype="multipart/form-data" >
				...
				<div class="form-group">
					...
					<input type="number" name="area" value="${itemLand.area }" step="5" class="wpcf7-number" placeholder="Nhập m2">
				</div><br/>
				<div class="form-group">
				...
				<p>
					<input type="submit" name="submit" class="wpcf7-submit" value="Sửa tin" />
				</p>
			</form>
		</div>
	</div>
